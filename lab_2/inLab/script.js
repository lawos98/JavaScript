...
function loadTestValues(){
    ...
    document.getElementById("cases").value="1"
    document.getElementById("deaths").value="2"
    document.getElementById("tests").value="3"
    document.getElementById("vaccine").value="4"
}

describe('The sum() function', function() {
    it('Incorect Country', function() {
        loadTestValues()
        document.getElementById("country").value="blabla"
        expect(validate()).to.equal(false);
    });
    it('Incorect Cases', function() {
        loadTestValues()
        document.getElementById("cases").value=""
        expect(validate()).to.equal(false);
    });
    it('Incorect Deaths', function() {
        loadTestValues()
        document.getElementById("deaths").value=""
        expect(validate()).to.equal(false);
    });
    it('Incorect Tests', function() {
        loadTestValues()
        document.getElementById("tests").value=""
        expect(validate()).to.equal(false);
    });
    it('Incorect Vaccine', function() {
        loadTestValues()
        document.getElementById("vaccine").value=""
        expect(validate()).to.equal(false);
    });
    it('Incorect Cases', function() {
        loadTestValues()
        document.getElementById("cases").value="aaa"
        expect(validate()).to.equal(false);
    });
    it('Incorect Deaths', function() {
        loadTestValues()
        document.getElementById("deaths").value="aaa"
        expect(validate()).to.equal(false);
    });
    it('Incorect Tests', function() {
        loadTestValues()
        document.getElementById("tests").value="aaa"
        expect(validate()).to.equal(false);
    });
    it('Incorect Vaccine', function() {
        loadTestValues()
        document.getElementById("vaccine").value="aaa"
        expect(validate()).to.equal(false);
    });
    it('Reset Form', function() {
        ...
        validate()
        resetForm()
        expect(document.getElementById("vaccine").value==="").to.equal(true);
    });
});